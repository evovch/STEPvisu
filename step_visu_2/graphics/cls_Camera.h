...
class cls_GraphicsWidget;

class cls_Camera
{
public:
   cls_Camera(cls_GraphicsWidget* linkedW, glm::vec3 p_center, float p_radius);
   ~cls_Camera(void);
   ...
   //cls_GraphicsWidget* GetWidget() { return linkedWidget; }
   void SetWidget(cls_GraphicsWidget* linkedW) { linkedWidget = linkedW; }
...
private:
   ...
   // Linked renderer (widget)
   cls_GraphicsWidget* linkedWidget;
